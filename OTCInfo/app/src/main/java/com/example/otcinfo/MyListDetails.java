...
public class MyListDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView activeText= findViewById(R.id.tv48); activeText.setText(item.activeIngredientsString());
        TextView ageText= findViewById(R.id.tv50); ageText.setText(item.getAge());
        TextView sideText= findViewById(R.id.tv52); sideText.setText(item.sideEffectsString());
        TextView interText= findViewById(R.id.tv54); interText.setText(item.interactionsString());
        TextView contText= findViewById(R.id.tv56);  contText.setText(item.contraindicationsString());
        TextView appText= findViewById(R.id.tv58); appText.setText(item.getApplication());
        TextView noteText= findViewById(R.id.tv60); noteText.setText(item.notesString());
